...
def meta_file():
    ...
    tmp['dailymet_livneh2013']['reference']=dict()
    ...
    tmp['dailymet_livneh2015']['reference']=dict()
    ...
    tmp['dailymet_livneh2015']['variable_info'] = dict()
    tmp['dailymet_livneh2015']['variable_info']['PRECIP'] = dict()
    tmp['dailymet_livneh2015']['variable_info']['PRECIP']={'desc':'daily precipitation (mm)',
                                                           'dtypes':'float64','units':'mm'}
    tmp['dailymet_livneh2015']['variable_info']['TMAX'] = dict()
    tmp['dailymet_livneh2015']['variable_info']['TMAX']={'desc':'daily maximum temperature (C)',
                                                         'dtypes':'float64','units':'C'}
    tmp['dailymet_livneh2015']['variable_info']['TMIN'] = dict()
    tmp['dailymet_livneh2015']['variable_info']['TMIN']={'desc':'daily minimum temperature (C)',
                                                         'dtypes':'float64','units':'C'}
    tmp['dailymet_livneh2015']['variable_info']['WINDSPD'] = dict()
    ...
    tmp['dailyvic_livneh2013']['reference']=dict()
    ...
    tmp['dailyvic_livneh2013']['variable_info'] = dict()
    tmp['dailyvic_livneh2013']['variable_info']['YEAR'] = dict()
    tmp['dailyvic_livneh2013']['variable_info']['YEAR']={'desc':'year',
                                                         'dtypes':'int8','units':'yr'}
    tmp['dailyvic_livneh2013']['variable_info']['MONTH'] = dict()
    tmp['dailyvic_livneh2013']['variable_info']['MONTH']={'desc':'month',
                                                          'dtypes':'int8','units':'mo'}
    tmp['dailyvic_livneh2013']['variable_info']['DAY'] = dict()
    tmp['dailyvic_livneh2013']['variable_info']['DAY']={'desc':'day',
                                                        'dtypes':'int8','units':'day'}
    tmp['dailyvic_livneh2013']['variable_info']['EVAP'] = dict()
    ...
    """
    tmp['dailymet_bclivneh2013'] = dict()
    ...
    tmp['dailymet_bclivneh2013']['reference']=dict()
    ...
    tmp['dailymet_bclivneh2013']['variable_info'] = dict()
    tmp['dailymet_bclivneh2013']['variable_info']['PRECIP'] = dict()
    tmp['dailymet_bclivneh2013']['variable_info']['PRECIP']={'desc':'daily precipitation (mm)',
                                                             'dtypes':'float64','units':'mm'}
    tmp['dailymet_bclivneh2013']['variable_info']['TMAX'] = dict()
    tmp['dailymet_bclivneh2013']['variable_info']['TMAX']={'desc':'daily maximum temperature (C)',
                                                           'dtypes':'float64','units':'C'}
    tmp['dailymet_bclivneh2013']['variable_info']['TMIN'] = dict()
    tmp['dailymet_bclivneh2013']['variable_info']['TMIN']={'desc':'daily minimum temperature (C)',
                                                           'dtypes':'float64','units':'C'}
    tmp['dailymet_bclivneh2013']['variable_info']['WINDSPD'] = dict()
    ...
    tmp['dailyvic_livneh2015']['reference']=dict()
    ...
    tmp['dailyvic_livneh2015']['variable_info']=dict()
    tmp['dailyvic_livneh2015']['variable_info']['YEAR']=dict()
    tmp['dailyvic_livneh2015']['variable_info']['YEAR']={'desc':'year',
                                                         'dtypes':'int8','units':'yr'}
    tmp['dailyvic_livneh2015']['variable_info']['MONTH']=dict()
    tmp['dailyvic_livneh2015']['variable_info']['MONTH']={'desc':'month',
                                                          'dtypes':'int8','units':'mo'}
    tmp['dailyvic_livneh2015']['variable_info']['DAY']=dict()
    tmp['dailyvic_livneh2015']['variable_info']['DAY']={'desc':'day',
                                                        'dtypes':'int8','units':'day'}
    tmp['dailyvic_livneh2015']['variable_info']['EVAP']=dict()
    ...
    tmp['dailywrf_salathe2014']['variable_info'] = dict()
    tmp['dailywrf_salathe2014']['variable_info']['PRECIP'] = dict()
    tmp['dailywrf_salathe2014']['variable_info']['PRECIP']={'desc':'Daily accumulated precipitation',
                                                            'dtypes':'float64','units':'mm'}
    tmp['dailywrf_salathe2014']['variable_info']['TMAX'] = dict()
    tmp['dailywrf_salathe2014']['variable_info']['TMAX']={'desc':'Maximum temperature at 2m',
                                                          'dtypes':'float64','units':'C'}
    tmp['dailywrf_salathe2014']['variable_info']['TMIN'] = dict()
    tmp['dailywrf_salathe2014']['variable_info']['TMIN']={'desc':'Minimum temperature at 2m',
                                                          'dtypes':'float64','units':'C'}
    tmp['dailywrf_salathe2014']['variable_info']['WINDSPD'] = dict()
    ...
    """
    tmp['dailywrf_bcsalathe2014']=dict()
    ...
    tmp['dailywrf_bcsalathe2014']['reference']=dict()
    ...
    tmp['dailywrf_bcsalathe2014']['variable_info'] = dict()
    tmp['dailywrf_bcsalathe2014']['variable_info']['PRECIP'] = dict()
    tmp['dailywrf_bcsalathe2014']['variable_info']['PRECIP']={'desc':'Daily accumulated precipitation',
                                                              'dtypes':'float64','units':'mm'}
    tmp['dailywrf_bcsalathe2014']['variable_info']['TMAX'] = dict()
    tmp['dailywrf_bcsalathe2014']['variable_info']['TMAX']={'desc':'Maximum temperature at 2m',
                                                            'dtypes':'float64','units':'C'}
    tmp['dailywrf_bcsalathe2014']['variable_info']['TMIN'] = dict()
    tmp['dailywrf_bcsalathe2014']['variable_info']['TMIN']={'desc':'Minimum temperature at 2m',
                                                            'dtypes':'float64','units':'C'}
    tmp['dailywrf_bcsalathe2014']['variable_info']['WINDSPD'] = dict()
